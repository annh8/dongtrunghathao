...
@Component({
  selector: 'page-tuyendung',
  templateUrl: './page-tuyendung.component.html',
  styleUrls: ['./page-tuyendung.component.scss']
})
export class PageTuyendungComponent implements OnInit,OnDestroy {
  ...
  onSave(event) {
    if (window.confirm('Are you sure you want to save?')) {
      ...
      this.service.saveTuyenDung(this.new);
      this.onClear();
      alert('Save success');
    } else {
      this.proFocusElement.nativeElement.focus();
